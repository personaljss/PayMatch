          ...
          Expanded(
            ...
            child: Row(
              ...
              children: [
                ...
                const SizedBox(width: 8.0,),
                Text("${(result.amountHold * result.ask)} ₺",
                  style: kPriceTextStyle,
                ),
              ],
            ),
          ...
          Expanded(
            ...
            child: Row(
              ...
              children: [
                ...
                const SizedBox(width: 8.0,),
                Text("${((result.amountHold * 0) - (result.amountHold * result.ask))} ₺",
                  style: kPriceTextStyle,),
              ],
            ),
          ),
          Expanded(
            ...
            child: Row(
              ...
              children: [
                ...
                const SizedBox(width: 8.0,),
                Text("${((result.amountHold * 0) - (result.amountHold * result.ask)) / ((result.amountHold * result.ask)) * 100}",
                  style: kPriceTextStyle,
                ),
              ],
            ),
